...
exports.PersonagemModule = PersonagemModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: personagem_schema_1.Personagem.name, schema: personagem_schema_1.PersonagemSchema }])],
        controllers: [personagem_controller_1.PersonagemController],
        providers: [personagem_service_1.PersonagemService],
        exports: [personagem_service_1.PersonagemService]
    })
], PersonagemModule);
